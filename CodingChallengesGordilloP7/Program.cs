...
class Challenges
{
    ...
    public static void MenuSelect()
    {
        ...
        {
            //Challenge 22
            Console.WriteLine("We are going to use a program that takes an array of numbers and return both the minimum and maximum numbers, in that order.\nPlease enter the number of items you want in your array.");
        ...
        {
            //Challenge 24
            Console.WriteLine("We are using a function that takes an integer and takes it to the power of another integer\nGive me an integer for the base.");
            int basePowerInt = int.Parse(Console.ReadLine());
